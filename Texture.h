...
{
public:
	Texture(const uint16_t width, const uint16_t height) noexcept;
...
{
public:
	Texture2D(const uint16_t width, const uint16_t height, const uint16_t rowPitch, void* pData) noexcept;
